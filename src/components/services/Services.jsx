          ...
          <div className="flex gap-5 max-md:flex-col">
            ...
            <div className="flex flex-col ml-5 w-[44%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col items-end self-stretch my-auto max-md:mt-10 max-md:max-w-full">
                ...
                <div className="flex shrink-0 self-stretch mt-12 w-full h-px bg-white max-md:mt-10 max-md:mr-2.5" />
                <div className="flex flex-col mt-12 text-white max-md:mt-10 max-md:mr-2.5">
                  <div className="text-5xl font-bold uppercase max-md:text-4xl">
                    Optimization
                  </div>
  ...
  return (
    <div className="flex overflow-hidden flex-col justify-center items-center px-20 py-36 bg-black max-md:px-5 max-md:py-24">
      <div className="flex flex-col items-center w-full max-w-[1440px] max-md:max-w-full">
        ...
        <div className="flex shrink-0 mt-16 max-w-full h-0.5 bg-stone-300 w-[1360px] max-md:mt-10" />
